...
import { getCookie } from "../../app/api/util/util";
...
export const updateBasketItemAsync = createAsyncThunk<Basket, { productId: number, quantity?: number }>(
    "basket/updateBasketItemAsync",
    async ({ productId, quantity }) => {
        try {
